    ...
    <div class="row">
      <div class="col-md-12">
        <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="4" data-md-items="4" data-sm-items="2" data-xs-items="1" data-space="20">
          ...
          $r = $pdo->query("SELECT * FROM cars WHERE purchase_date <= (NOW() + INTERVAL 2 MONTH)");
          while ($cars = $r->fetch(PDO::FETCH_ASSOC)) {
          ?>

            <div class='item'>
              <div class='car-item text-center'>
                <div class='car-image'><img class='img-fluid' src='<?php echo $cars["img"]; ?>' alt=''>
                  <div class='car-overlay-banner'>
                    <ul>
                      <li><a href="descriptif_vehicule.php?id_car=<?= $cars['id_car'] ?>">
                      <i class=' fa fa-link'></i> </li> <!--<li><a href='#'><i class='fa fa-dashboard'></i></a></li>-->
                    </ul>
                  </div>
                </div>
                <div class='car-list'>
                  <ul class='list-inline'>
                    <li><i class='fa fa-registered'></i><?php echo $cars["first_registration_car"]; ?></li>
                    <li><i class='fa fa-cog'></i> NAN </li>
                    <li><i class='fa fa-dashboard'></i><?php echo $cars["km"]; ?></li>
                  </ul>
                </div>
                <div class='car-content'>
                  ...
                  <a href='cars/mt03.html'> <?php echo $cars["model_car"]; ?> </a>
                  <div class='separator'>
                  </div>
                  <div class='price'>
                    <span class='old-price'><?php echo $cars["old_selling_price"]; ?></span><span class='new-price'><?php echo $cars["selling_price"]; ?></span>
                    <a href="descriptif_vehicule.php?id_car=<?= $cars['id_car'] ?>" class=\"btn btn-primary\">Fiche détaillée</a>
                  </div>
                </div>
              </div>
            </div>
