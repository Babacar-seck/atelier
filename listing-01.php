...
?>
                  ...
                  <div class='col-lg-4'>
                     <div class='car-item gray-bg text-center'>
                        <div class='car-image'>
                           <img class='img-fluid' src='<?php  echo $cars["img"]; ?>' alt=''>
                           <div class='car-overlay-banner'>
                              <ul>
                                 <li>
                                 <a href="descriptif_vehicule.php?id_car=<?=$cars['id_car']?>">
                        ...
                        <div class='car-list'>
                           <ul class='list-inline'>
                              ...
                              <li><i class='fa fa-cog'></i><?php  echo $cars["gearbox"]; ?></li>
                              <li><i class='fa fa-shopping-cart'></i><?php  echo $cars["km"]; ?></li>
                           </ul>
                        </div>
                        <div class='car-content'>
                           ...
                           <a href='#'><?php echo $cars["model_car"]; ?></a>
                           <div class='separator'></div>
                           <div class='price'><span class='old-price'><?php  echo $cars["old_selling_price"]; ?></span><span class='new-price'><?php  echo $cars["selling_price"]; ?></span></div>
                        </div>
                     </div>
                  </div>
